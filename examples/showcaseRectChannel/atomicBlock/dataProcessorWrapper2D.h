...
void integrateProcessingFunctional(
    BoxProcessingFunctional2D_TT<T1, nDim1, T2, nDim2> *functional, Box2D domain,
    TensorField2D<T1, nDim1> &field1, TensorField2D<T2, nDim2> &field2, plint level = 0);
...
void integrateProcessingFunctional(
    BoxProcessingFunctional2D_LS<T1, Descriptor, T2> *functional, Box2D domain,
    BlockLattice2D<T1, Descriptor> &lattice, ScalarField2D<T2> &field, plint level = 0);
...
void integrateProcessingFunctional(
    BoxProcessingFunctional2D_LT<T1, Descriptor, T2, nDim> *functional, Box2D domain,
    BlockLattice2D<T1, Descriptor> &lattice, TensorField2D<T2, nDim> &field, plint level = 0);
...
void integrateProcessingFunctional(
    BoxProcessingFunctional2D_LN<T1, Descriptor, T2> *functional, Box2D domain,
    BlockLattice2D<T1, Descriptor> &lattice, NTensorField2D<T2> &field, plint level = 0);
...
void integrateProcessingFunctional(
    DotProcessingFunctional2D *functional, DotList2D const &dotList,
    std::vector<AtomicBlock2D *> atomicBlocks, plint level = 0);
...
void integrateProcessingFunctional(
    DotProcessingFunctional2D_SS<T1, T2> *functional, DotList2D const &dotList,
    ScalarField2D<T1> &field1, ScalarField2D<T2> &field2, plint level = 0);
...
void integrateProcessingFunctional(
    DotProcessingFunctional2D_NN<T1, T2> *functional, DotList2D const &dotList,
    NTensorField2D<T1> &field1, NTensorField2D<T2> &field2, plint level = 0);
...
void integrateProcessingFunctional(
    DotProcessingFunctional2D_ST<T1, T2, nDim> *functional, DotList2D const &dotList,
    ScalarField2D<T1> &field1, TensorField2D<T2, nDim> &field2, plint level = 0);
...
void integrateProcessingFunctional(
    DotProcessingFunctional2D_SN<T1, T2> *functional, DotList2D const &dotList,
    ScalarField2D<T1> &field1, NTensorField2D<T2> &field2, plint level = 0);
...
void integrateProcessingFunctional(
    BoundedBoxProcessingFunctional2D *functional, Box2D domain,
    std::vector<AtomicBlock2D *> atomicBlocks, plint boundaryWidth, plint level = 0);
...
void applyProcessingFunctional(
    ...
    BlockLattice2D<T, Descriptor> &lattice, plint boundaryWidth = Descriptor<T>::boundaryWidth);
...
void integrateProcessingFunctional(
    BoundedBoxProcessingFunctional2D_T<T, nDim> *functional, Box2D domain,
    TensorField2D<T, nDim> &field, plint boundaryWidth, plint level = 0);
...
void integrateProcessingFunctional(
    BoundedBoxProcessingFunctional2D_SS<T1, T2> *functional, Box2D domain,
    ScalarField2D<T1> &field1, ScalarField2D<T2> &field2, plint boundaryWidth, plint level = 0);
...
void integrateProcessingFunctional(
    BoundedBoxProcessingFunctional2D_NN<T1, T2> *functional, Box2D domain,
    NTensorField2D<T1> &field1, NTensorField2D<T2> &field2, plint boundaryWidth, plint level = 0);
...
void integrateProcessingFunctional(
    BoundedBoxProcessingFunctional2D_SN<T1, T2> *functional, Box2D domain,
    ScalarField2D<T1> &field1, NTensorField2D<T2> &field2, plint boundaryWidth, plint level = 0);
