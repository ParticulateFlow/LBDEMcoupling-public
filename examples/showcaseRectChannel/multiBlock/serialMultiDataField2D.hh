...
namespace plb {
template <typename T>
SerialScalarAccess2D<T>::SerialScalarAccess2D() : locatedBlock(0)
{ }
...
SerialTensorAccess2D<T, nDim>::SerialTensorAccess2D() : locatedBlock(0)
{ }
...
template <typename T>
SerialNTensorAccess2D<T>::SerialNTensorAccess2D() : locatedBlock(0)
{ }
