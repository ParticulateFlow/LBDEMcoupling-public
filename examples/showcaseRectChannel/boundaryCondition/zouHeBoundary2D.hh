...
BoundaryCompositeDynamics<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getVelocityBoundaryDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
...
BoxProcessingFunctional2D_L<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getVelocityBoundaryFunctional()
{
    return 0;
}
...
template <int direction, int orientation>
BoundaryCompositeDynamics<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getPressureBoundaryDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
...
template <int direction, int orientation>
BoxProcessingFunctional2D_L<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getPressureBoundaryFunctional()
{
    return 0;
}
...
template <int xNormal, int yNormal>
BoundaryCompositeDynamics<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getExternalVelocityCornerDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
...
template <int xNormal, int yNormal>
BoxProcessingFunctional2D_L<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getExternalVelocityCornerFunctional()
{
...
template <int xNormal, int yNormal>
BoundaryCompositeDynamics<T, Descriptor>
    *ZouHeBoundaryManager2D<T, Descriptor>::getInternalVelocityCornerDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
...
template <int direction, int orientation>
BoundaryCompositeDynamics<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getVelocityBoundaryDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
...
template <int direction, int orientation>
BoxProcessingFunctional2D_L<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getVelocityBoundaryFunctional()
{
...
template <int direction, int orientation>
BoundaryCompositeDynamics<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getPressureBoundaryDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
    bool automaticPrepareCollision = false;
...
template <int direction, int orientation>
BoxProcessingFunctional2D_L<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getPressureBoundaryFunctional()
{
    return new WrappedLocalBoundaryFunctional2D<T, Descriptor>();
}
...
template <int xNormal, int yNormal>
BoundaryCompositeDynamics<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getExternalVelocityCornerDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
    return new StoreVelocityDynamics<T, Descriptor>(baseDynamics);
}
...
template <int xNormal, int yNormal>
BoxProcessingFunctional2D_L<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getExternalVelocityCornerFunctional()
{
    return new OuterVelocityCornerFunctional2D<T, Descriptor, xNormal, yNormal>();
}
...
template <int xNormal, int yNormal>
BoundaryCompositeDynamics<T, Descriptor>
    *WrappedZouHeBoundaryManager2D<T, Descriptor>::getInternalVelocityCornerDynamics(
        Dynamics<T, Descriptor> *baseDynamics)
{
    bool automaticPrepareCollision = false;
    return new RegularizedVelocityInnerCornerDynamics2D<T, Descriptor, xNormal, yNormal>(
...
OnLatticeBoundaryCondition2D<T, Descriptor> *createZouHeBoundaryCondition2D()
{
    return new BoundaryConditionInstantiator2D<
        T, Descriptor, WrappedZouHeBoundaryManager2D<T, Descriptor> >();
}
...
{
    return new BoundaryConditionInstantiator2D<
        T, Descriptor, ZouHeBoundaryManager2D<T, Descriptor> >();
}
